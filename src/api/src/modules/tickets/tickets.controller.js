...
var TicketsController = exports.TicketsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('tickets'), (0, common_1.Controller)('api/tickets')];
    ...
    var TicketsController = _classThis = /** @class */ (function () {
        ...
        TicketsController_1.prototype.create = function (data) {
            return this.ticketsService.create(data);
        };
        TicketsController_1.prototype.update = function (id, data) {
            return this.ticketsService.update(id, data);
        };
        TicketsController_1.prototype.remove = function (id) {
